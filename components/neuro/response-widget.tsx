...
// Floating widget with all visual elements
// ==============================================
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <CognitiveSurface
            variant="floating"
            glow={state === "thinking" ? "magenta" : state !== "idle" ? "cyan" : "none"}
            className="relative"
          >
            {/* Close button */}
            {onDismiss && (
              <button
                ...
                type="button"
                className="absolute right-3 top-3 p-1 rounded-full opacity-50 hover:opacity-100 hover:bg-secondary/50 transition-all"
                aria-label="Fermer"
              >
                <svg
                  width="16"
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="font-[var(--font-orbitron)] text-sm font-semibold tracking-wider text-primary uppercase">
                  Neuro
                </h3>
                <p className="text-xs text-muted-foreground font-mono">
                  Cognitive Interface v1.0
                </p>
              </div>
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  <div className="py-6">
                    ...
                    <div className="relative h-16 flex items-center justify-center">
                      <motion.div
                        className="absolute w-32 h-1 rounded-full bg-gradient-to-r from-transparent via-accent to-transparent"
                        animate={{
                          x: [-60, 60, -60],
                          opacity: [0.5, 1, 0.5],
                        }}
                      ...
                      />
                      <motion.div
                        className="absolute w-20 h-1 rounded-full bg-gradient-to-r from-transparent via-primary to-transparent"
                        animate={{
                          x: [40, -40, 40],
                          opacity: [0.5, 1, 0.5],
                        }}
              ...
              {state === "error" && (
                <motion.div
                  ...
                  className="overflow-hidden"
                >
                  <div className="py-4 px-3 rounded-lg bg-destructive/10 border border-destructive/30">
